...
Bayesian optimization results helps us to manually explore hyper-parameters and model parameter optimal results, achieving 17.91% accuracy as shown below. Bayesian simulations were run on an Azure VM NC4as T4 v3 instance over four days:
